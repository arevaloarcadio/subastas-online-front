<template>
  <ion-page>
    ...
    <ion-row>
      ...
      <ion-col>
          <span class="text-control" style="font-family: Montserrat;font-style: normal;font-weight: 500;font-size: 20px;line-height: 24px;align-items: center;text-align: center;letter-spacing: 0.75px;">Nombre del Usuario</span> 
     ...
     <div style="display: flex;justify-content: center;">
      <img style="border-radius: 10px 10px 0px 0px;width: 132px;height: 120px;margin-left: 59px;" src="https://ionicframework.com/docs/demos/api/card/madison.jpg">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <svg width="62" height="50" viewBox="0 0 62 50" fill="none" xmlns="http://www.w3.org/2000/svg" style="position: absolute;margin-top: 38px;">
       ...
       <img style="border-radius: 10px 10px 0px 0px;width: 132px;height: 120px;margin-right: 59px;" src="https://ionicframework.com/docs/demos/api/card/madison.jpg">
    </div>
    <br><br>  
     <div  style="display: flex;justify-content: center;">
      ...
      <button type="button" class="btn-primary" style="width: 136px;" @click="redirect({name : 'add_message.requests'})" >
        Ver Oferta
      </button>
      ...
      <br><br><br>
      <center>
      <a  class="text-control">Cambiar preferencias de chat</a>
      </center>
