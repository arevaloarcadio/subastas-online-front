  ...
  <ion-content class="ion-padding">
    <ion-row>
      <ion-col>
       ...
       <ion-input class="input-text-edit-profile" style="width: 68%;margin-left: -7px;"  @ionBlur="event($event)" id="name" > </ion-input>
   ...
   <ion-row>
      <ion-col>
       ...
       <ion-input class="input-text-edit-profile" style="width: 68%;margin-left: -7px;"  @ionBlur="event($event)" id="email" > </ion-input>
   ...
   <div class="hr-black"> </div> 
    <ion-row>
      <ion-col>
       ...
       <ion-input class="input-text-edit-profile" id="pais" style="width: 68%;margin-left: -7px;" inputmode="text" @ionBlur="event($event)" > </ion-input>
    ...
    <ion-row>
      <ion-col>
       ...
       <ion-input class="input-text-edit-profile"  id="city" style="width: 68%;margin-left: -7px;" inputmode="text" @ionBlur="event($event)" > </ion-input>
   ...
   <div class="hr-black"> </div>
    <ion-row>
      <ion-col>
       ...
       <ion-input class="input-text-edit-profile" style="width: 68%;margin-left: -7px;" id="dir" inputmode="text"  @ionBlur="event($event)" > </ion-input>
   ...
   <div class="hr-black"> </div>
    <ion-row>
      <ion-col>
       ...
       <ion-input class="input-text-edit-profile" id="phone" style="width: 68%;margin-left: -7px;" inputmode="text" @ionBlur="event($event)" > </ion-input>
