            ...
            <ion-col col-12>
              <div class="container" style="cursor: pointer;">
                ...
                <div  class="input-container" v-else>
                   <svg @click="takenImageUrl = null" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" style="position: fixed;margin-left: 80%;margin-top: -116px;z-index: 12;">
