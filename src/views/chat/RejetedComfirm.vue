    ...
    async rejectedProduct(){
      ...
      axios
        ...
        .then(res => {
          ...
          send_notification.send('Tu Producto ha sido rechazado',this.product_customer.name,{data: {path : {name :'request.rejected' , params : { requestId : this.request_id }}},message : 'Tu Producto ha sido rechazado - '+this.product_customer.name },this.request.id_user)
