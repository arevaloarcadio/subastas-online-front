<template>
  <ion-page>
    ...
    <br><br>
    <div  style="display: flex;justify-content: center;">
       <button type="button"  class="btn-line" style="line-height: 15px;width: 71px;" @click="redirect({name : 'request.confirm.accepted' , params : { productId : $route.params.productId}})" >
            Si
        </button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <button type="button"  class="btn-primary" style="width: 71px;" @click="redirect({name : 'request.confirm.rejected' , params : { productId : $route.params.productId}})" >
            No
      </button>
    </div>
