<template>
  <ion-page>
    <ion-row>
     ...
     <svg width="70" height="56" viewBox="0 0 70 56" fill="none" xmlns="http://www.w3.org/2000/svg" style="position: absolute;margin-left: 43%;margin-top: 166px;z-index: 10000;">
    ...
    <ion-card style="box-shadow: inherit;width: 87%;left: 4%;height: 161px;margin-top: -25px;">
       <ion-row>
   
             <img style="border-radius: 10px 10px 0px 0px;width: 106.62px;height: 98px;margin-left: 50px;margin-top: 70px;" src="https://ionicframework.com/docs/demos/api/card/madison.jpg">
         ...
         <ion-col>
          ...
          <img style="border-radius: 10px 10px 0px 0px;width: 106.62px;height: 98px;margin-right: 31px;margin-top: 71px;" src="https://ionicframework.com/docs/demos/api/card/madison.jpg">
    ...
    <p style="margin-top: 15px;">  
      <ion-row>
        <ion-col>
           <button type="button"  class="btn-line" style="line-height: 15px;width: 71px;margin-left: 100px;" @click="redirect({name : 'request.confirm.accepted' , params : { productId : $route.params.productId}})" >
            Si
          </button>
        </ion-col>
         <ion-col>
           <button type="button"  class="btn-primary" style="width: 71px;margin-left: -55px;" @click="redirect({name : 'request.confirm.rejected' , params : { productId : $route.params.productId}})" >
            NO
          </button>
        </ion-col>
      </ion-row>
