<template>
  <ion-page>
    ...
    <br><br>
    <div  style="display: flex;justify-content: center;">
        <button type="button" class="btn-primary" style="line-height: 15px;width: 200px;" @click="aceptedProduct()" >
        Sí, estoy seguro
      </button>
    </div>
...
export default defineComponent({
  ...
  methods:{
    ...
    axios
      .put("/exchanges/"+this.request_id+"/Aceptada",{
